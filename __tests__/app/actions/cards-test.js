...
describe('actions', () => {
    it('should create an action to invalidate card data', () => {
        const expectedAction = {
            type: types.INVALIDATE_CARDS_DATA,
        };
        expect(actions.invalidateCardData()).toEqual(expectedAction);
    });
});


describe('actions', () => {
    it('should create an action to request card data', () => {
        const expectedAction = {
            type: types.REQUEST_CARDS_DATA,
        };
        expect(actions.requestCardData()).toEqual(expectedAction);
    });
});

describe('actions', () => {
    it('should create an action to receive card data', () => {
        const data = [
            {
                "pack_code": "core",
                "pack_name": "Core Set",
        ...
        let returnData = actions.receiveCardData(data);
        expect(returnData.type).toEqual(expectedAction.type);
        expect(returnData.data).toEqual(expectedAction.data);
